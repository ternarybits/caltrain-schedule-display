...
var newcss = newcss + 'table.ipf-caltrain-table-trains th div { background: white; border-bottom: 2px; }';
// schedule
var newcss = newcss + 'table.ipf-caltrain-table-trains td { font-size: 100%; }';
// This display provides...
var newcss = newcss + '.ipf-caltrain-stationselector-displaytext p { font-size: 30%; margin-bottom: 4px}';
// Alerts
...
attributionNode.innerHTML = "<div style='padding-left: 15px; font-size: 30%'>Caltrain schedule bookmarklet from <a href='https://github.com/ternarybits/caltrain-schedule-display'>https://github.com/ternarybits/caltrain-schedule-display</a></div>";
containerNode = document.getElementsByClassName('ipf-caltrain-stationselector')[0];
containerNode.appendChild(attributionNode.firstChild);
